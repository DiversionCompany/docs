...
#### Repo's workspaces default automatic update setting

<img style={{width: '81px', height: '79px', borderRadius: '0.5rem', border: '.1rem solid #555', boxShadow: '0 0 1rem #888' }} src="/images/syncing/DefAutoForwardingToggle.png" alt="Diversion's Desktop App Workspace's Auto-Update Toggle" />

Admins and repo owners can set the default auto-update value of future workspaces of the selected repo.

`Click on your profile icon -> Your organizations -> Repositories`

<Note>It will **not** effect existing workspaces' settings, and can be changed manually by each individual user.</Note>
