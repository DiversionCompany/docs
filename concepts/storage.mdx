...
<Card title="" icon="triangle-exclamation" iconType="duotone" color="#ca8b04">
  We do have a process that “aligns” organization membership with repo collaboration lists. So if someone is added as a collaborator to a repo that is part of an organization - the new member will be added to the org overnight.
</Card>
