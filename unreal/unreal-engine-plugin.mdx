...
<Steps>
    <Step title="Get the plugin">
      Search for `Diversion` in the <a href="https://www.unrealengine.com/marketplace/en-US/product/diversion">Unreal Engine Marketplace</a> or click here to
      directly open the <a href="com.epicgames.launcher://ue/marketplace/product/diversion">Epic Games Launcher</a>,
      then click on the `Free` button to add the plugin to your account.
      <img alt="Acquire plugin" style={{width: '90%', borderRadius: '1.5rem', border: '.3rem solid #555', boxShadow: '0 0 1rem #888' }} src="/images/get-diversion-plugin.png" />
    </Step>
    <Step title="Install the plugin">
      In the same <a href="com.epicgames.launcher://ue/marketplace/product/diversion">Epic Games Launcher Diversion page</a>,
      click `Install to Engine` and choose the version of Unreal Engine you want to install the plugin to.
