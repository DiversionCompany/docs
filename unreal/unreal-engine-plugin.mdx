...
<Steps>
    <Step title="Get the plugin">
      ...
      <img alt="Acquire plugin" style={{width: '90%', borderRadius: '1.5rem', border: '.3rem solid #555', boxShadow: '0 0 1rem #888' }} src="/images/unreal-plugin-add-to-library.png" />
      Then, click on the `Download` button and click on the `Epic Games Launcher` link to go to your engine assets library.
      <img alt="Acquire plugin" style={{width: '90%', borderRadius: '1.5rem', border: '.3rem solid #555', boxShadow: '0 0 1rem #888' }} src="/images/unreal-plugin-open-launcher.png" />
    ...
    <Step title="Install the plugin">
      ...
      <img alt="Install plugin" style={{width: '90%', borderRadius: '1.5rem', border: '.3rem solid #555', boxShadow: '0 0 1rem #888' }} src="/images/unreal-plugin-install-to-engine.png" />
      Choose the correct version of the Unreal Engine you want to install the plugin to and click `Install`.
      <img alt="Install plugin" style={{width: '90%', borderRadius: '1.5rem', border: '.3rem solid #555', boxShadow: '0 0 1rem #888' }} src="/images/install-diversion-plugin.png" />
    </Step>
    <Step title="Alternative: Build plugin from source">
      ...
      - Unreal Engine 5.3: [Diversion-v1.1.21-ue5.3.0.zip](https://get.diversion.dev/ue-plugin/Diversion-v1.1.21-ue5.3.0-nobin.zip)
      - Unreal Engine 5.4: [Diversion-v1.1.21-ue5.4.0.zip](https://get.diversion.dev/ue-plugin/Diversion-v1.1.21-ue5.4.0-nobin.zip)
      - Unreal Engine 5.5: [Diversion-v1.1.21-ue5.5.0.zip](https://get.diversion.dev/ue-plugin/Diversion-v1.1.21-ue5.5.0-nobin.zip)
      - Unreal Engine 5.6: [Diversion-v1.1.21-ue5.6.0.zip](https://get.diversion.dev/ue-plugin/Diversion-v1.1.21-ue5.6.0-nobin.zip)
