...
If you have any changes in your workspace that you haven't committed, they will move with you to the new branch, if possible (see [merge Conflicts](#merge-conflicts)).
