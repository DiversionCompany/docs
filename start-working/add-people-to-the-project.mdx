---
title: 'Add people to the project'
description: 'Add collaborators to your repo'
---

{/* TODO(omer s) redirect from basic/share-your-repo */}

You have a project set up, and want to add your team mates? Here's how:
...
<Steps>
  <Step title="Open the repo's menu and choose 'Repo Collaborators'">
    ...
    If you don't have a repo yet, [create one first](/start-working/new-project).
  </Step>
...
That's it! Your team mate will receive an email invitation to join the project.
They can accept it and start collaborating with you. If they don't have Diversion installed yet, they'll be prompted to do so.