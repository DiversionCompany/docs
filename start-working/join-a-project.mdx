...
description: 'Clone a repo you''re invited to'
---

{/* TODO(omer s) redirect from basic/clone-repo */}

A team member has [set up Diversion](/start-working/new-project) for you project and [invited you to join](/start-working/add-people-to-the-project). Let's get you set up:
