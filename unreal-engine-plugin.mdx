...
<Steps>
    ...
    - Unreal Engine 5.3: [https://get.diversion.dev/ue-plugin/Diversion-v0.1.2-ue5.3.zip](https://get.diversion.dev/ue-plugin/Diversion-v0.1.2-ue5.3.zip).
    - Unreal Engine 5.4: [https://get.diversion.dev/ue-plugin/Diversion-v0.1.2-ue5.4.zip](https://get.diversion.dev/ue-plugin/Diversion-v0.1.2-ue5.4.zip).
    </Step>
...
<Steps>
  ...
  <Step title="Initialize repository">
    ...
    If your project is already a Diversion repository, like in the case of cloning or after clicking the initialization button, just click 'Accept Settings' to activate the plugin.
