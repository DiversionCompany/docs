...
{/*
### Method 2: Create Review from Draft Commit
...
**The inline comment will show:**
- Which file it's on
- The exact line number
- The code context around it
- Whether it's on the "before" (left/base) or "after" (right/compare) side
...
- **CHANGES REQUESTED** (orange): You requested modifications
...
All reviews compare two things. Usually those "things" are branches, but they can also be specific commits or tags.
...
- Create reviews early, even for work-in-progress, to get feedback sooner
- Use inline comments to explain tricky parts of your code preemptively
- Add multiple commits that each do one thing - easier for reviewers to follow
- Update the review description if your approach changes

### For Reviewers

- Review promptly - don't block your teammates
- Start with the big picture before diving into details
- Explain WHY something should change, not just WHAT to change
- Approve when it's "good enough" - don't demand perfection
- If you're not the right reviewer, suggest someone else

## Common Questions

**Q: Can I review my own code?**
A: You're automatically part of the review as the author, but you should have at least one other person review it.

**Q: How many approvals do I need?**
A: This depends on your team's policy. At minimum, having one other person review catches most issues.

**Q: Can I change who's reviewing after I create the review?**
A: Yes! You can add or remove reviewers at any time while the review is open.

**Q: What if I need to make changes after approval?**
A: If you make significant changes, ask reviewers to take another look. Small fixes usually don't need re-approval.

**Q: Can I close a review without merging?**
A: Yes. Sometimes you realize you need a different approach, or the changes are no longer needed. Just close it.

**Q: What happens to the review after I merge?**
A: It becomes read-only and marked as MERGED. You can still view it for historical reference, but can't add more comments or change status.
