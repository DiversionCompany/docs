...
<img src="/images/reviews/review-before-submit.png" alt="Review form before submitting" />
...
1. **Open the review**
   ...
   <img src="/images/reviews/create-review-step-1.png" alt="Reviews section in top header bar" />
...
3. **Review the changes**
   ...
   <img src="/images/reviews/files-changed.png" alt="Files changed tab showing code diff" />
...
4. **Leave comments** (explained below)
   ...
   - Add inline comments on specific lines of code
    ...
    <img src="/images/reviews/review-changes-conversation.png" alt="Conversation tab with comments" />
...
<img src="/images/reviews/add-comments.png" alt="Adding and replying to comments" />
...
2. Go to the **"Files Changed"** tab
3. Find the file you want to comment on
4. Click the **"+"** button above the changed version of the fil
5. A comment box appears on the right side of the screen
6. Type your comment about the entire file
7. Click **"Comment"** button

<img src="/images/reviews/file-comments.png" alt="Adding inline and file-level comments" />
...
<img src="/images/reviews/review-status.png" alt="Review status indicators" />
